## PC2P2000T - Laden van P2000T programma's vanaf PC naar P2000T (via seriele poort)
...
Ook kun je de [sendcas.py](sendcas.py) Python utility gebruiken, die zelf de juiste baudrate instelt en ook niet-opgesplitste .cas bestanden (zoals Errorsoft.cas) correct kan overzetten.
