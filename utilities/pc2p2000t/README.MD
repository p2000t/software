...
?usr1(0)
```
En vervolgens op de PC een .cas bestand sturen naar de juiste COM poort (bijv. het spel BrickWall)
```
...
Op github zijn trouwens veel .cas bestanden te vinden: https://github.com/p2000t/software/tapes
