...
?USR1(0)
```
Nu kun je vanaf je PC een .cas bestand sturen via de juiste COM poort m.b.v. het `pc_to_pc2000t.py` script. Als voorbeeld hieronder hoe je het bestand BrickWall.cas verstuurt via COM5:
```
