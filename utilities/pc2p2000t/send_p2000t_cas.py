...
def send_file_to_serial(file_path, serial_port):
...
if __name__ == '__main__':
    ...
    parser.add_argument("file_path", nargs='+', help="Path(s) to the .cas/.p2000t file(s)")
    ...
    try:
        ...
        for file_path in args.file_path:
            send_file_to_serial(file_path, serial_port)
        print('Done!')
